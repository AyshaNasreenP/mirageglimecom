          ...
          child: Container(
            ...
            GridView.builder(
              //physics: NeverScrollableScrollPhysics(),
                ...
                itemCount:Ringscolletions.length,
                itemBuilder: (BuildContext ctx, index) {
                  return GestureDetector(
                    onTap: (){
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context)=> product(
                            image: Ringscolletions[index].image,
                            description: Ringscolletions[index].description,
                            price: Ringscolletions[index].price,
                           )));
                    },
                    child: Container(
                      //color: Colors.black,
                        ...
                        child: Column(
                          children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    image:  DecorationImage(
                                      image: AssetImage(Ringscolletions[index].image),
                            ...
                            Text(Ringscolletions[index].description,
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w400,
                              ),),

                            Text(Ringscolletions[index].price,
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w400,
                              ),),
