    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Center(child: Text("EAR RINGS",
            style: TextStyle(
                color: mirage,
          ...
          child: Container(
            ...
            GridView.builder(
              //physics: NeverScrollableScrollPhysics(),
                ...
                itemCount:Earringcolletions.length,
                itemBuilder: (BuildContext ctx, index) {
                  return GestureDetector(
                    onTap: (){
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context)=> product(
                            image: Earringcolletions[index].image,
                            description:  Earringcolletions[index].description,
                            price:  Earringcolletions[index].price,
                            )));
                    },
                    child: Container(
                      //color: Colors.black,
                        ...
                        child: Column(
                          children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    image:  DecorationImage(
                                      image: AssetImage(Earringcolletions[index].image),
                            ...
                            Text(Earringcolletions[index].description,
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w400,
                              ),),

                            Text(Earringcolletions[index].price,
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w400,
                              ),),
